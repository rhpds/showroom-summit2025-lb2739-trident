...
[NOTE]
====
A *SVM* ("Storage Virtual Machine") is an ONTAP virtual which serves data to clients and hosts from one or more volumes, through one or more network logical interfaces (LIFs). 
====
