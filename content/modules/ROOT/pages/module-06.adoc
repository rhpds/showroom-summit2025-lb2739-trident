...
NOTE: You may see a temporary warning message if you refresh to quickly. Do no take it into account, it will disappear soon.

[IMPORTANT]
====
Resynchronizing the mirror will stop and delete everything but the PVC on the DR site. When an AMR is established, the only object you can see in the DR is the PVC. +
